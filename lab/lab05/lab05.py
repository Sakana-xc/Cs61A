...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    coordinate = make_city("cor", lat, lon)
...
def berry_finder(t):
    ...
    if label(t) == 'berry':
        ...
        result = [berry_finder(b)for b in branches(t)]
...
def sprout_leaves(t, leaves):
    ...
    if is_leaf(t):
        leaves_branches = [tree(i, [])for i in leaves]
        return tree(label(t), leaves_branches)
    else:
        add_leaves = [sprout_leaves(b, leaves)for b in branches(t)]
        new_tree = tree(label(t), add_leaves)
        return new_tree
