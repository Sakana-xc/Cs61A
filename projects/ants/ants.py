...
class Place:
    ...
    def __init__(self, name, exit=None):
        ...
        "*** YOUR CODE HERE ***"
        if self.exit:
            exit.entrance = self  # update exit.entrance be itself
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while target is not beehive:
            if len(target.bees) > 0 and self.min_range <= distance <= self.max_range:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        # BEGIN Problem 5
        "*** YOUR CODE HERE ***"
        # once fire_ants receive dmg, it returns reduced armor amount of dmg to self.place.bees
        # once armor reduced to zero, amount= armor+dmg
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    # which one is the first Queen, one_true_queen = True
    # develop a method called is_true_queen, when self.true. double dmg,
    # self.place = self.place.exit
    # when self.false, self.reduce_armor(self.armor)
    # when queen dies, bees_win()
    ...
    def __init__(self, armor=1):
        ...
        # END Problem EC
    # first instance, false->self.is_true_queen = True /sec and after True-> self.is_true_queen = False

    def remove_from(self, place):
        # can't be removed if self.is_true_queen
    ...
    def action(self, gamestate):
        ...
        if self.is_true_queen:
            ...
            while location:  # while exit != None
                if location.ant != None and location.ant.buffed == False:
                    location.ant.damage = 2*location.ant.damage
